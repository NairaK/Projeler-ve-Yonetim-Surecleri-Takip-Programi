...
<body>
    ...
    <asp:GridView ID="dvProje" runat="server" AutoGenerateColumns="False" 
            ...
            CellPadding="3" Width="860px" GridLines="None" BackColor="White" 
            BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" 
        CellSpacing="1" CssClass="style5" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
            <Columns>
                <asp:BoundField HeaderStyle-Width="140px" HeaderStyle-Wrap="false" DataField="projeKodu" HeaderText="Proje Kodu" ReadOnly="true" SortExpression="projeKodu" />
                <asp:TemplateField ItemStyle-Width="300px" ItemStyle-Wrap="false" SortExpression="projeTanimi" HeaderText="Proje Tanımı">
                    <ItemTemplate>
                ...
                <asp:TemplateField ItemStyle-Width="104px" ItemStyle-Wrap="false" SortExpression="projeYoneticisi" HeaderText="Proje Yöneticisi">
                    <ItemTemplate>
                    ...
                    <EditItemTemplate>
                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("projeYoneticisi") %>' 
                            Width="100px"></asp:TextBox><span class="style14">*</span>
                    </EditItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField ItemStyle-Width="182px" ItemStyle-Wrap="false" SortExpression="olcumAnalizSorumlusu" HeaderText="Ölçüm ve Analiz Sorumlusu">
                    <ItemTemplate>
