...
<body>
    ...
    </strong><span class="style9"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    SÜREÇ ÖLÇÜM VE ANALİZ PLANI</strong></span><br />
    <br />
    ...
    <asp:GridView ID="dvProje" runat="server" AutoGenerateColumns="False" 
            ...
            CellPadding="3" Width="1000px" GridLines="None" BackColor="White" 
        ...
        onpageindexchanging="dvProje_PageIndexChanging" PageSize="5">
            <Columns>
                ...
                <asp:TemplateField SortExpression="surecSahibi" HeaderText="Süreç Sahibi">
                    <ItemTemplate>
                        <asp:Label ID="Label2" runat="server" Width="93px" Text='<%# Bind("surecSahibi") %>' Height="56px"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField ControlStyle-Width="135px" SortExpression="CMMISurecAlani" HeaderText="CMMI Süreç Alanı">
                    <ItemTemplate>
                        <asp:Label ID="Label3" runat="server" Text='<%# Bind("CMMISurecAlani") %>' Height="56px"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField ControlStyle-Width="310px" SortExpression="izlemeMetrigi" HeaderText="İzleme Metriği">
                    <ItemTemplate>
                        <asp:Label ID="Label4" runat="server" Text='<%# Bind("izlemeMetrigi") %>' Height="56px"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField ControlStyle-Width="111px" SortExpression="raporPeriyodu" HeaderText="Rapor Periyodu">
                    <ItemTemplate>
                        <asp:Label ID="Label5" runat="server" Text='<%# Bind("raporPeriyodu") %>' Height="56px"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField SortExpression="Hedef" HeaderText="Hedef">
                    <ItemTemplate>
                        <asp:Label ID="Label6" runat="server" Width="55px" Text='<%# Bind("Hedef") %>' Height="56px"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
                ...
                <asp:TemplateField ControlStyle-Width="83px" SortExpression="olcuBirimi" HeaderText="Ölçü Birimi">
                    <ItemTemplate>
                        <asp:Label ID="Label7" runat="server" Text='<%# Bind("olcuBirimi") %>' Height="56px"></asp:Label>
                    </ItemTemplate>
                    <EditItemTemplate>
    ...
    <p>
        ...
        <asp:TextBox ID="TextBox1" runat="server" CssClass="style3" Height="18px" 
...
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:ImageButton ID="ImageButton5" runat="server" 
        ...
        CssClass="style12" Height="64px" Width="64px" />
    <br />
    <asp:Label ID="Label8" runat="server" Text="Başl.Tarihi : "></asp:Label>
    <asp:TextBox ID="TextBox8" runat="server" ReadOnly="true" CssClass="style14" 
        Width="128px"></asp:TextBox>   
    &nbsp;&nbsp;<asp:Button ID="Button1" runat="server" Text="Seç" 
    ...
    &nbsp;&nbsp;<asp:Button ID="Button2" runat="server" Text="Seç" CssClass="style15" 
        Width="36px" onclick="Button2_Click" />
    <asp:Calendar Visible="false" ID="Calendar1" runat="server" BackColor="White" 
